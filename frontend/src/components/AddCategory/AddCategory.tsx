...
import {
  CategoryInitValues,
  CategorySchema,
} from "../Form/Validations/CategorySchema";
...
function AddCategory({
  ...
  return (
    <div className="AddCategory">
      <div
        className={`content  ${AnimateAddPCategory && "animate_content"}`}
          ...
          onSubmit={async (values: any, { setFieldError }) => {
            ...
            if (data) {
              try {
                ...
                categoryDispatch(
                  updateCategoryAction(updatedCategory.data.data)
                );
            ...
            <Form>
              ...
              <div className="flex justify-between flex-wrap md:flex-nowrap items-end">
                <button
                  ...
                  onClick={() => HandleAddCategoryAnimi()}
                >
                  Cancel
                </button>
                <button
