...
import {
  ProductInitValue,
  ProductSchema,
} from "../Form/Validations/ProductSchema";
...
function AddProduct({
  ...
  return (
    <div className="AddProduct">
      <div
        className={`content  ${AnimateAddProduct && "animate_content"}`}
        ...
        <Formik
          ...
          onSubmit={async (values: any, { setFieldError }) => {
            if (!values.gallery.length)
              return setFieldError("gallery", "Images Required");
                      ...
                      {values.gallery &&
                        values.gallery.map(
                          (image: string | File, index: number) => (
                            <div
                              className={`Selected_Images_Single ${
                                image === mainImage && "Selected_MainImage"
                              }`}
                              key={index}
