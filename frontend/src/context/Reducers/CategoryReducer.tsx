...
import {
  ...
  getCategories,
  isLoading,
} from "../../context/Actions/CategoryActions/CategoryActions-types";
import { CategoriesProps } from "../../context/InitialStates/CategoriesInitialState";
  ...
  switch (action.type) {
    ...
    case createCategory:
      ...
      return {
        ...
        TotalPages:
          newCurrentPage > state.TotalPages ? newCurrentPage : state.TotalPages,
        isLoading: false,
      };
    case editCategory:
      return {
